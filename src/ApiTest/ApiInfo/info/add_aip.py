...
class AddApi:
    ...
    """
    @staticmethod
    def add_api(api_name, project_name, module_name, path, pre_parameter, headers, debug_headers, body, debug_body,
                after_parameter, assert_sql, assert_parameter, create_user):
        """
        新增基础接口
        :param api_name: 接口名称
        ...
        # 项目信息插入数据库
        info = ApiInfo(apiName=api_name, projectName=project_name, moduleName=module_name, path=path,
